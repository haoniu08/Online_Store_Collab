"""
Locust performance test for HW8 DynamoDB Shopping Cart API
Runs exactly 150 operations: 50 create, 50 add items, 50 get
Outputs dynamodb_test_results.json in required format
"""
import json
import time
...
def on_test_start(environment, **kwargs):
    ...
    if not isinstance(environment.runner, WorkerRunner):
        print(f"Starting HW8 DynamoDB performance test: {TOTAL_OPERATIONS} operations")
